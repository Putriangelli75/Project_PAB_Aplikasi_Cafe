...
var cafeList = [
  ...
  Cafe(
    ...
    imageUrls: ['images/koat/koat.jpg'],
    isFavorite: false,
  ),
  Cafe(
    ...
    imageUrls: ['images/for-good-luck/for_good_luck.jpg'],
    isFavorite: false,
  ),
  Cafe(
  ...
  Cafe(
    ...
    imageAsset: 'images/soree/soree.jpg',
    imageUrls: ['images/soree/soree.jpg'],
    isFavorite: false,
  ),
  Cafe(
    ...
    imageUrls: ['images/taki/taki.jpg'],
    isFavorite: false,
  ),
  Cafe(
    ...
    imageAsset: 'images/cce-space/cce_space.jpg',
    imageUrls: ['images/cce-space/cce_space.jpg'],
    isFavorite: false,
  ),
  Cafe(
    ...
    imageAsset: 'images/dayone/dayone.jpg',
    imageUrls: ['images/dayone/dayone.jpg'],
    isFavorite: false,
  ),
  Cafe(
    ...
    imageUrls: ['images/days-cafe/days-cafe.jpg'],
    isFavorite: false,
  ),
  Cafe(
    ...
    imageAsset: 'images/eightynine/eightynine.jpg',
    imageUrls: ['images/eightynine/eightynine.jpg'],
    isFavorite: false,
  ),
  Cafe(
    ...
    imageUrls: ['images/enamdua/enamdua.jpg'],
    isFavorite: false,
  ),
  Cafe(
    ...
    imageAsset: 'images/kopi-dari-hati/kopi-dari-hati.jpg',
    imageUrls: ['images/kopi-dari-hati/kopi-dari-hati.jpg'],
    isFavorite: false,
  ),
  Cafe(
    ...
    imageAsset: 'images/luthier/luthier.jpg',
    imageUrls: ['images/luthier/luthier.jpg'],
    isFavorite: false,
  ),
  Cafe(
    ...
    jamOperasional: '09.00 – 22.00 WIB',
    imageAsset: 'images/york-cafe/york-cafe.jpg',
    imageUrls: ['images/york-cafe/york-cafe.jpg'],
    isFavorite: false,
  ),
];
